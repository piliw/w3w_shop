		 ...
		 <li class="active"img>
			 ...
			 <div class="banner_menu_content" style="width: 600px; top: -20px;">
				 <ul class="banner_menu_content_ul">
					 <li>
						 <a><img src="/home/img/headphone.jpg"></a><a>唯尚衣族耳机</a><span>选购</span></li>
					 <li>
						 <a><img src="/home/img/headphone.jpg"></a><a>唯尚衣族耳机</a><span>选购</span></li>
					 <li>
						 <a><img src="/home/img/headphone.jpg"></a><a>唯尚衣族耳机</a><span>选购</span></li>
            ...
            <div class="lklksp">
            	<ul>
                	<li>
                    	<a href="#">
                        	<b>
                            	<img src="/home/img/diannaozhuji.png"/>
                            </b>
                            <h5>游戏主机</h5>
                            <p>强劲性能，所向披靡</p>
                            <span>9999元</span>
                ...
                <!--全部评论-->
                    ...
                    <!--一条评论开始-->
                        ...
                        <!--左-->
                        	<div class="zuileftop">
                            	<!--改变星级只需要改" no-repeat X 0"里面的X即可，一次是17像素-->
                            	<div class="thstar" style=" background:url(/home/img/commentsListIcons1.png) no-repeat -17px 0"></div>
                                <div class="shdltpl">收货1天后评论</div>
                                <div class="shdplsj">2016-6-6&nbsp;16:28</div>
                            </div>
                        <!--中-->
                    ...
                    <!--一条评论开始-->
                        ...
                        <!--左-->
                        	<div class="zuileftop">
                            	<!--改变星级只需要改" no-repeat X 0"里面的X即可，一次是17像素-->
                            	<div class="thstar" style=" background:url(/home/img/commentsListIcons1.png) no-repeat -51px 0"></div>
                                <div class="shdltpl">收货1天后评论</div>
                                <div class="shdplsj">2016-6-6&nbsp;16:28</div>
                            </div>
                        <!--中-->
                    ...
                    <!--一条评论开始-->
                        ...
                        <!--左-->
                        	<div class="zuileftop">
                            	<!--改变星级只需要改" no-repeat X 0"里面的X即可，一次是17像素-->
                            	<div class="thstar" style=" background:url(/home/img/commentsListIcons1.png) no-repeat -68px 0"></div>
                                <div class="shdltpl">收货1天后评论</div>
                                <div class="shdplsj">2016-6-6&nbsp;16:28</div>
                            </div>
                        <!--中-->
                    ...
                    <!--一条评论开始-->
                        ...
                        <!--左-->
                        	<div class="zuileftop">
                            	<!--改变星级只需要改" no-repeat X 0"里面的X即可，一次是17像素-->
                            	<div class="thstar" style=" background:url(/home/img/commentsListIcons1.png) no-repeat -82px 0"></div>
                                <div class="shdltpl">收货1天后评论</div>
                                <div class="shdplsj">2016-6-6&nbsp;16:28</div>
                            </div>
                        <!--中-->
